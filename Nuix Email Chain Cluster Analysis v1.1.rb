# Menu Title: Nuix Email Chain Cluster Analysis v1.1
...
# Needs Case: true
# Menu Title: Email Cluster Tagging v1.1
# encoding: utf-8
...
$current_case.generateClusterRun("Email Cluster #{T1}",cluster_items,cluster_settings)    # So if you want to do that, comment out these two lines and put line 13 back into play. 
...
bulk_tagger.add_tag("08 Email-Unnecessary", current_case.search(%Q[kind:email NOT tag:Email*])) # Emails that are not required for review on the basis of NOT being any of the above. 
